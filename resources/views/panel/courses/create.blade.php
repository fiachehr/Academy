...
@section('pageTitle', 'Create new cource')
@section('style')
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::open(['method' => 'POST', 'url' => 'course']) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::textarea('description', '', ['id' => 'description', 'autocomplete' => 'off', 'tabindex' => '2', 'class' => $errors->has('description') ? 'form-control is-invalid' : 'form-control']) !!}
                    @error('description')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group date">
                    ...
                    <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                        {!! Form::text('ts_expire', '', ['id' => 'reservationdatetime', 'autocomplete' => 'off', 'tabindex' => '3', 'class' => $errors->has('ts_expire') ? 'form-control datetimepicker-input is-invalid' : 'form-control datetimepicker-input', 'data-target' => '#reservationdate']) !!}
                ...
                <div class="form-group">
                    {!! Form::submit('Create New Cource', ['class' => 'btn btn-primary btn-block']) !!}
                </div>
