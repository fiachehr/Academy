...
@section('pageTitle', 'Edit Lesson | ' . $lesson->title)
@section('style')
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {!! Form::model($lesson, ['method' => 'PATCH', 'url' => ['lesson/update', $lesson->id]]) !!}
                ...
                <div class="form-group">
                    {!! Form::submit('Edit Currnet Lesson', ['class' => 'btn btn-primary btn-block']) !!}
                </div>
