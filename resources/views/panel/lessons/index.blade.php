...
@section('pageTitle', 'Lessons List')
@section('content')
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-8 text-right"><a href="{{ url('lesson/create/' . $courseID) }}"
                            class="btn btn-primary">Create New Lesson</a></div>
                </div>
            </div>
            <div class="card-body">
                        ...
                        @foreach ($list as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('homework/create/' . $item->id) }}">
                                        <i class="fas fa-plus text-success "></i>
                                    </a>
                                </td>
                                <td class="text-center">
                                    <a href="{{ url('homework/index/' . $item->id) }}">
                                        <i class="fas fa-list text-success "></i>
                                    </a>
                                </td>
                                <td class="text-center">
                                    <a href="{{ url('lesson/edit/' . $item->id) }}">
                                        <i class="fas fa-edit text-warning "></i>
                                    </a>
                                </td>
                                <td class="text-center">
                                    {!! Form::open(['method' => 'DELETE', 'url' => 'lesson/destroy/' . $item->id]) !!}
